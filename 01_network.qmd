...
membership_community$family <- strsplit(membership_community$family, split = "/") |> 
    ...
    unlist()
write.txt(membership_community, file = "membership_community_gene_cluster_added.txt")
```
...
plot_topology_parameter <- function(.topology_bahd = topology_bahd, 
    ...
    ## select the columns
    topology_l <- topology |> 
        dplyr::select(any_of(plot), number_nodes, family)
    ...
    if (.model) {
        ...
        gg <- ggboxplot(df, x = "family", y = "value") |>
...
print("average_local_efficiency")
...
print("betweenness_normalized_min")
plot_topology_parameter(plot = "betweenness_normalized_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("betweenness_normalized_median")
plot_topology_parameter(plot = "betweenness_normalized_median", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("betweenness_normalized_max")
plot_topology_parameter(plot = "betweenness_normalized_max", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("betweenness_notnormalized_min")
plot_topology_parameter(plot = "betweenness_notnormalized_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("betweenness_notnormalized_median")
plot_topology_parameter(plot = "betweenness_notnormalized_median", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("betweenness_notnormalized_max")
plot_topology_parameter(plot = "betweenness_notnormalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE)

## closeness
print("closeness_normalized_min")
plot_topology_parameter(plot = "closeness_normalized_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 4)
print("closeness_normalized_median")
plot_topology_parameter(plot = "closeness_normalized_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 4)
print("closeness_normalized_max")
plot_topology_parameter(plot = "closeness_normalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 3)
print("closeness_notnormalized_min")
plot_topology_parameter(plot = "closeness_notnormalized_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 6)
print("closeness_notnormalized_median")
plot_topology_parameter(plot = "closeness_notnormalized_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 6)
print("closeness_notnormalized_max")
plot_topology_parameter(plot = "closeness_notnormalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 6)

## constraint
print("constraint_min")
plot_topology_parameter(plot = "constraint_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("constraint_median")
plot_topology_parameter(plot = "constraint_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
...
## degree
print("degree_normalized_min")
plot_topology_parameter(plot = "degree_normalized_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("degree_normalized_median")
plot_topology_parameter(plot = "degree_normalized_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("degree_normalized_max")
plot_topology_parameter(plot = "degree_normalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("degree_notnormalized_min")
plot_topology_parameter(plot = "degree_notnormalized_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("degree_notnormalized_median")
plot_topology_parameter(plot = "degree_notnormalized_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("degree_notnormalized_max")
plot_topology_parameter(plot = "degree_notnormalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)

## eccentricity
print("eccentricity_min")
plot_topology_parameter(plot = "eccentricity_min", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("eccentricity_median")
plot_topology_parameter(plot = "eccentricity_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("eccentricity_max")
plot_topology_parameter(plot = "eccentricity_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)

## edge_betweenness
print("edge_betweenness_min")
plot_topology_parameter(plot = "edge_betweenness_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0)
print("edge_betweenness_median")
plot_topology_parameter(plot = "edge_betweenness_median", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0)
print("edge_betweenness_max")
plot_topology_parameter(plot = "edge_betweenness_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)

## eigen_centrality
print("eigen_centrality_min")
plot_topology_parameter(plot = "eigen_centrality_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0)
print("eigen_centrality_median")
plot_topology_parameter(plot = "eigen_centrality_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("eigen_centrality_max")
plot_topology_parameter(plot = "eigen_centrality_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("eigen_centrality_value")
...
## shortest_paths
print("shortest_paths_min")
plot_topology_parameter(plot = "shortest_paths_min", log10_x = FALSE, log10_y = F,
    offset_x = 0, offset_y = 0, .model = FALSE)
print("shortest_paths_median")
plot_topology_parameter(plot = "shortest_paths_median", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0)
print("shortest_paths_max")

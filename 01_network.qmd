...
## write the topology parameters to a file
write.table(topology_bahd[[1]], file = "topology_values_component_BAHD.txt", 
    quote = FALSE, sep = "\t", dec = ".", row.names = FALSE)
write.table(topology_scpl[[1]], file = "topology_values_component_SCPL.txt", 
    quote = FALSE, sep = "\t", dec = ".", row.names = FALSE)
```
...
plot_topology_parameter <- function(.topology_bahd = topology_bahd, 
    ...
    custom_ticks_x = c(3, 5, 10, 25, 50, 100, 250, 500, 750, 1250), custom_ticks_y = c(0.1, 1)) {
...
tp <- plot_topology_parameter(plot = "average_local_efficiency", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = FALSE, .digits_y = 6,
    custom_ticks_y = c(0.001, 0.005, 0.01, 0.015, 0.05, 0.1, 0.5))
tp$scatter
tp$scatter_plotly
## tp$bootstrap
...
tp <- plot_topology_parameter(plot = "mean_distance", log10_x = TRUE, 
    ...
    custom_ticks_y = c(1, 5, 10, 25, 50, 100, 250, 500, 1500, 5000, 10000, 15000))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(
    ...
    offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 10,
    custom_ticks_y = c(0.01, 0.1, 1, 10, 100, 1000, 10000, 30000, 100000, 300000, 1000000))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "closeness_normalized_min", log10_x = TRUE, 
    ...
    custom_ticks_y = c(1e-05, 1e-04, 1e-03, 1e-02, 1e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "closeness_normalized_median", 
    log10_x = TRUE, log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, 
    .digits_y = 6,
    custom_ticks_y = c(1e-04, 1e-03, 1e-02, 1e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "closeness_notnormalized_min", 
    log10_x = TRUE, log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, 
    .digits_y = 10,
    custom_ticks_y = c(1e-08, 1e-07, 1e-06, 1e-05, 1e-04, 1e-03, 1e-02, 1e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "closeness_notnormalized_median", 
    ...
    custom_ticks_y = c(1e-07, 1e-06, 1e-05, 1e-04, 1e-03, 1e-02, 1e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "constraint_min", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e-02, 5e-02, 1e-01, 5e-01, 1e-00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "constraint_median", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(3e-02, 1e-01, 3e-01, 1e-00, 3e-00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "diameter", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e0, 1e1, 1e2, 1e3, 1e4, 1e5, 2e5))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "degree_normalized_min", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 10,
    custom_ticks_y = c(5e-04, 1e-03, 1e-02, 1e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "degree_normalized_median", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 10,
    custom_ticks_y = c(1e-02, 3e-02, 1e-01, 3e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "degree_normalized_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 10,
    custom_ticks_y = c(1e-01, 3e-01, 1e00, 1.3e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "degree_notnormalized_min", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = FALSE,
    custom_ticks_y = c(0.5, 1, 1.5, 2, 3))
tp$scatter
tp$scatter_plotly
# tp$bootstrap
# tp$ttest
tp <- plot_topology_parameter(plot = "degree_notnormalized_median", 
    log10_x = TRUE, log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(5e-01, 1e00, 3, 5, 1e01, 30, 50, 100))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "degree_notnormalized_max", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 5e00, 1e01, 5e01, 1e02, 5e02))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eccentricity_min", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(5e-01, 1e00, 5e00, 1e01))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eccentricity_median", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 2e00, 5e00, 1e01, 2e01))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eccentricity_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1, 2, 3, 4, 6, 8, 10, 12.5, 15))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "edge_betweenness_min", log10_x = FALSE, 
    log10_y = FALSE, offset_x = 0, offset_y = 0.0, .model = FALSE,
    custom_ticks_y = c(0.0, 0.05, 0.1, 1, 10))
tp$scatter
tp$scatter_plotly
# tp$bootstrap
...
tp <- plot_topology_parameter(plot = "edge_betweenness_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 3e00, 1e01, 3e01, 1e02, 3e02, 1e03, 3e03, 1e04, 3e04, 1e05, 3e05))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eigen_centrality_min", log10_x = TRUE, 
    ...
    custom_ticks_y = c(1e-14, 1e-12, 1e-10, 1e-8, 1e-6, 1e-04, 1e-02, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eigen_centrality_median", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e-04, 3e-04, 1e-03, 3e-03, 0.01, 0.03, 0.1, 0.3, 1e00), .digits_y = 10)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eigen_centrality_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e-01, 1.5e-01, 2e-01, 3e-01, 4e-01, 5e-01, 6e-01, 7e-01, 8e-01, 1e00), .digits_y = 10)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "eigen_centrality_value", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 1e1, 1e2, 1e3, 1e4, 1e5, 1e6, 1e7))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "global_efficiency", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e-04, 1e-03, 1e-02, 1e-01, 1e00), .digits_y = 3)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "harmonic_centrality_min", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE, .digits_y = 10,
    custom_ticks_y = c(0.01, 0.02, 0.03, 0.05, 0.07, 1e-01, 2e-01, 5e-01, 1e00))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "harmonic_centrality_median", 
    log10_x = TRUE, log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(0.2, 0.3, 0.4, 0.6, 1, 2), .digits_y = 10,)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "harmonic_centrality_max", log10_x = TRUE,
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1, 2, 3, 4, 5, 7), .digits_y = 10,)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "neighborhood_size_median", 
    log10_x = TRUE, log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1, 5, 7, 10, 15, 30, 50, 70))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "neighborhood_size_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1, 3, 5, 10, 20, 30, 50, 100, 200, 300, 500), .digits_y = 10) 
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "radius", log10_x = TRUE, log10_y = TRUE,
    ...
    custom_ticks_y = c(0.8, 1, 2, 3, 4, 5, 6, 7, 8))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "strength_min", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(0.5, 1, 2, 5, 10, 20, 50, 100, 200, 500, 1000, 1500))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "strength_median", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 1e01, 1e02, 1e03, 1e04, 1e05, 1e06, 1e07), .digits_y = 10)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "strength_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(1e00, 1e01, 1e02, 1e03, 3e03, 1e04, 3e04, 1e05, 3e05, 1e06, 3e06, 1e07))
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "distances_median", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(3e-01, 1e00, 3e00, 1e01, 3e01, 1e02, 3e02, 1e03, 3e03, 1e04), .digits_y = 10)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
tp <- plot_topology_parameter(plot = "distances_max", log10_x = TRUE, 
    log10_y = TRUE, offset_x = 0, offset_y = 0, .model = TRUE,
    custom_ticks_y = c(3e00, 1e01, 3e01, 1e02, 3e02, 1e03, 3e03, 1e04, 3e04, 1e05, 3e05), .digits_y = 10)
tp$scatter
tp$scatter_plotly
tp$bootstrap

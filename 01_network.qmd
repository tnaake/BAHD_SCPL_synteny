...
plot_topology_parameter <- function(.topology_bahd = topology_bahd, 
    ...
    if (.model) {
        ...
        gg_boxplot <- ggboxplot(df, x = "family", y = "value", title = plot) |>#, 
            ...
            facet(facet.by = "coefficient", scales = "free_y") +
...
```{r betweenness_normalized}
## betweenness_normalized
tp <- plot_topology_parameter(plot = "betweenness_normalized_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
tp$scatter
tp$scatter_plotly
# tp$bootstrap
...
# tp$bootstrap
# tp$ttest
plot_topology_parameter(plot = "betweenness_normalized_max", log10_x = TRUE, log10_y = TRUE,
    offset_x = 0, offset_y = 0, .model = FALSE)
tp$scatter
tp$scatter_plotly
# tp$bootstrap
...
```{r edge_betweenness}
## edge_betweenness
tp <- plot_topology_parameter(plot = "edge_betweenness_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0)
tp$scatter
tp$scatter_plotly
tp$bootstrap
ttest_edge_betweenness_min <- tp$ttest
tp <- plot_topology_parameter(plot = "edge_betweenness_median", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0)
tp$scatter
tp$scatter_plotly
tp$bootstrap
...
```{r eigen_centrality}
## eigen_centrality
tp <- plot_topology_parameter(plot = "eigen_centrality_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
tp$scatter
tp$scatter_plotly
# tp$bootstrap
...
```{r neighborhood_size}
## neighborhood_size
tp <- plot_topology_parameter(plot = "neighborhood_size_min", log10_x = FALSE, log10_y = FALSE,
    offset_x = 0, offset_y = 0, .model = FALSE)
tp$scatter
tp$scatter_plotly
# tp$bootstrap
...
#' ## TODO: add randomness in selecting the maximal.clique and let run n times, select the result with highest median of members 
#' 
...
for (component_i in seq_along(cliques_greedy)) {
    ...
    for (clique_i in seq_along(cliques_greedy[[component_i]])) {
        ...
        membership_community[ind_rows, "clique_og_mcl"] <- clique_i
    }
}
```
...
for (component_i in seq_along(cliques_greedy)) {
    ...
    for (clique_i in seq_along(cliques_greedy[[component_i]])) {
        ...
        membership_community[ind_rows, "clique_og"] <- clique_i
    }
}
```
